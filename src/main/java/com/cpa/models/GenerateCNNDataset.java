...
//                    double[] zipfDistribution = generateZipfDistributionDiff(numRequestTypes, 1.0);
                ...
                int currentTime = 0;
////            traditional attack attack user
...
//            Server server = servers.get(0);
                ...
                // calculate request ratio for each content
                for (int i = 0; i < numRequestTypes; i++) {
                ...
                // calculate standard deviation of Individual Request Intensity
                for (int i = 0; i < numRequestTypes; i++) {
