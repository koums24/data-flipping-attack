...
//                user.getRequestListPerUser();
            ...
            // Print the maximum ARI and contentId
//            System.out.println("maxARI\tcontentId");

            IndexValue maxARI = indexedArray[0];
//            System.out.println(maxARI.getValue() + "\t" + maxARI.getOriginalIndex());
    ...
    private static void newAttack(Server server, Set<Integer>[] usersforContent) {
